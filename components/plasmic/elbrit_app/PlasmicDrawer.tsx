...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: cr5IdD8aQQ1Q/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_wbHyc7ONIHSN"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox___7XwWc)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              <div className={classNames(projectcss.all, sty.freeBox__fSw7F)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button2
                  className={classNames("__wab_instance", sty.button2___5TBuf)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
