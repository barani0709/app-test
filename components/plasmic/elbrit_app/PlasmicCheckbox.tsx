...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: VZXjOb3dxF_c/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: MKmsy_PIsgmh/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: bBtWerfc6783/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__j0CD)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__pehs)}
            role={"img"}
          />
        ) : null}
      </div>
