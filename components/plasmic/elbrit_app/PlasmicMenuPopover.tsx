...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: FwFk60bWg-Zf/css
              ...
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames(
                      "__wab_instance",
                      sty.menuItem___1DyFq
                    )}
                    value={"item1"}
                  />

                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__c2SM)}
                    label={"Item 2"}
                    value={"item2"}
                  />
