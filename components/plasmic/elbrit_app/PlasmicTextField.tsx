...
import TextInput2 from "../../TextInput2"; // plasmic-import: VEl4bTiDNHDS/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: hKU0dxJy3xMK/component
import Description from "../../Description"; // plasmic-import: -q9Kq1g1Su2I/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: yEQck9scbnPy/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__rgra, {
          [sty.freeBoxiconEnd__rgra2UJjF]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__rgraXlKT]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__rgrAom7Im]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__sfCt, {
            [sty.freeBoxiconStart__sfCtXlKT]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__sfCtOm7Im]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__b1XNo)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__pVk8K, {
            [sty.freeBoxiconEnd__pVk8K2UJjF]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__pVk8KXlKT]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__kk6I1)}
                role={"img"}
              />
            ),
