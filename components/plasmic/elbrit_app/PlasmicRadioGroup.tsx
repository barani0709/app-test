...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: GYMz3GfToupI/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox___0Bjq7)}>
            <Radio
              className={classNames("__wab_instance", sty.radio___6Fexg)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio___0Aj6I)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__s0Pnn)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
