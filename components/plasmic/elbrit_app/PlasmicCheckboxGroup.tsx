...
import Checkbox from "../../Checkbox"; // plasmic-import: VZXjOb3dxF_c/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: CcLpvYSi9kP-/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox___3DphX)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__dJh4W)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__eymHt)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__xUpIw)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
