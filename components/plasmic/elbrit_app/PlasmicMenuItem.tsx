...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: uc7bJMLR_F-c/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__mbw8X)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__bd9Hm)}>
            <div
              className={classNames(
                projectcss.all,
