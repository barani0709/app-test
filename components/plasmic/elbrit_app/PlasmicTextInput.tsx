...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: n1KYdl7MSeQ4/css
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          placeholder: "Enter the Doctor name or Code"
        },
        Object.fromEntries(
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__latS2)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__iOoMw)}
              role={"img"}
            />
          ),
