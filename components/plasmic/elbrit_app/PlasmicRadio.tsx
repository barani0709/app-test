...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: FhAk9xxd_Y_r/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__ghBh3)}
        onClick={async event => {
          const $steps = {};
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__laoYc)} />
      </div>
      {renderPlasmicSlot({
