...
import SliderThumb from "../../SliderThumb"; // plasmic-import: j_REuXmh2OJO/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: tWo7iLrLYGQb/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__tQztz)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__u4PyQ)}>
        <div
