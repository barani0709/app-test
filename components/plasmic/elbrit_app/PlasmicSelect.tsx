...
import MenuPopover from "../../MenuPopover"; // plasmic-import: FwFk60bWg-Zf/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: X18jlD8v21Ca/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__zYrmT)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
